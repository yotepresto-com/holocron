...
CREATE OR REPLACE FUNCTION blacklist_natural_person_details_tgr_fn() RETURNS TRIGGER AS $$
DECLARE
    full_name TEXT;
BEGIN
...
FOR EACH ROW EXECUTE FUNCTION blacklist_natural_person_details_tgr_fn();
